...
export const WrapperInputModel = styled.div`
  width: 100%;
  display: flex;
  align-items: center;
  justify-content: center;
...
export const IconAdd = styled(MdOutlineAdd)`
  ...
  font-size: 25px;
`;
export const WrapperModelsBox = styled.div`
  background-color: ${({ theme }) => theme.BACKGROUND2};
  margin: 10px 0;
  height: 50px;
  position: relative;
...
export const WrapperModelValue = styled.div`
  color: ${({ theme }) => theme.TEXTCOLOR1};
...
export const IconRemoveModel = styled(MdOutlineRemoveCircle)`
  position: absolute;
  top: -5px;
  right: -5px;
